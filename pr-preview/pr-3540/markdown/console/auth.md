...
Apple sign-in joins soon and works the same way, deriving your Sui address from your Apple identity. It will accept Apple's private email relay, so you can use the **Hide My Email** option.
