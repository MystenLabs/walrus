...
> **Need WAL?**
>
> Use the official WAL exchange command for Testnet WAL. Third-party faucets can distribute WAL from a package the Walrus client does not accept. For more options, see [Testnet WAL faucet](/docs/system-overview/available-networks#testnet-wal-faucet).
