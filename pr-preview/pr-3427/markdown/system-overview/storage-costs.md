...
For Testnet, you can exchange Testnet SUI for Testnet WAL through the [Testnet WAL faucet](/docs/system-overview/available-networks#testnet-wal-faucet). Use the official exchange flow so the WAL package matches what the Walrus client expects.
