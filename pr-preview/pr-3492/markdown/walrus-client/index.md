...
- [Managing Blobs](/docs/walrus-client/managing-blobs): Use the Walrus client to extend, delete, burn, share, and set attributes on blobs.
...
- [Verify Blob Availability Before Acting](/docs/walrus-client/verifying-availability): A pattern for an agent to confirm a blob is durably stored on Walrus, by checking onchain Walrus state, before depending on it.
