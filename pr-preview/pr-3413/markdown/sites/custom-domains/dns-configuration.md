...
The following is a general-purpose [Nginx](https://nginx.org/en/docs/) configuration that proxies HTTPS traffic to a portal running on port 3000. This is not an officially supported Walrus Sites configuration, so adapt it to your environment:
