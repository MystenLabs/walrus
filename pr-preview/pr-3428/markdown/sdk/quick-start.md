...
| `serverUrl` | `string` | No | Relayer URL, use `https://relayer.memwal.ai` (Mainnet) or `https://relayer.staging.memwal.ai` (Testnet) for the [managed relayer](/walrus-memory/relayer/public-relayer) |
