...
> **Tip**
>
> Walrus uses erasure coding with approximately 5x expansion. The `walrus info` command accounts for this. You do not need to calculate the expansion yourself.
