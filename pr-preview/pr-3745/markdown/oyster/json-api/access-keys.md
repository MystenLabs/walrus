...
[S3-compatible API](../s3-api/index.mdx) using standard AWS Signature
...
|-----------|----------|-------------|
| [Create](admin.mdx#create-access-key) | `POST /api/v1/accounts/{account_id}/access-keys` | Create a new key pair |
