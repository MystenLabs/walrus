...
| `402` | Pearl-derived wallet lacks WAL/SUI to fund the upload (body carries a `funding_required` block; see [Cross-Cutting Error Contracts](index.mdx#cross-cutting-error-contracts)) |
...
[Get Wallet Address](wallet.mdx). When `delete_blob` returns `402`,
...
this JSON API and tags set through the [S3 Object Tagging](../s3-api/objects.mdx#object-tagging)
