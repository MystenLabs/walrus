...
see [Authentication](authentication.mdx)).
...
[Webhooks](../guides/webhooks.mdx) for the signature format.
...
expiring storage pools (see [Blob Lifecycle](../guides/blob-lifecycle.mdx)),
