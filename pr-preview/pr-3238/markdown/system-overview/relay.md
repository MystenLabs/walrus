...
Upload relays might require a tip to cover their operational costs. The Walrus TypeScript SDK can automatically query the tip configuration, calculate the required tip based on blob size, and include the tip in the registration transaction.
