...
| Tokens | Free from a faucet | Real SUI for gas and WAL for storage |
...
1. Run a [private authenticated publisher](/docs/operator-guide/publishers/mainnet-production-guide).
2. Use an [upload relay](#upload-relays).
3. Integrate the [TypeScript SDK](#typescript-sdk) directly.
