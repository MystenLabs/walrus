...
If your app pays for storage on behalf of its users, or lets users upload without a wallet, see [Sponsored and walletless uploads](/docs/sponsored-uploads) for the reference architecture and common pitfalls.
