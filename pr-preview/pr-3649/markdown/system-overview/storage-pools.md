...
|---|---|---|
| Create a pool | Reserved capacity × pool lifetime | — |
| Register a blob | — | Blob's encoded size, once |
| Extend the pool's lifetime | Full reserved capacity × added epochs | — |
| Increase the pool's capacity | Added capacity × remaining epochs | — |
| Delete a blob | — (frees capacity, no refund) | — |
