...
- An Oyster API key (Bearer token); see [Getting Started](../getting-started.mdx)
...
See [S3 Access Keys](../json-api/access-keys.mdx) for more on key format
and limits.
...
> **Warning**
>
> Always set `force_path_style: true` (or equivalent). Oyster
