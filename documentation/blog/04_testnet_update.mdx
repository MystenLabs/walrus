...
- Find out how to
  [upload and delete deletable blobs](/usage/client-cli#reclaiming-space-via-deletable-blobs)
  through the CLI.
- Find out more about how [delete operations work](/dev-guide/dev-operations#delete).
...
- Find out the [current epoch](/usage/client-cli#walrus-system-information) through the CLI.
- Find out how to store a blob for
  [multiple epochs](/usage/client-cli#storing-querying-status-and-reading-blobs).
...
Find out how to [request Testnet WAL tokens](/usage/setup#testnet-wal-faucet) through the CLI.
