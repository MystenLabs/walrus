...
[example smart contract](https://github.com/MystenLabs/walrus/tree/main/documentation/examples) that
implements a wrapped blob.

The following sections provide further insights into the contract and an
