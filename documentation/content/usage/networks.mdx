...
<ImportContent source="examples/setup/client_config_mainnet.yaml"/>
...
The configuration file described on the [setup page](/usage/setupx#configuration) includes both Mainnet
