...
Sui and Walrus each have the following available [networks](/usage/networks.mdx):
...
different servers through *erasure coding*. [Learn more](/design/encoding.mdx)
...
[Build your first Walrus application](/dev-guide/dev-guide.mdx). Explore
working examples:

- [Python examples](https://github.com/MystenLabs/walrus/tree/main/documentation/examples/python)
- [JavaScript web form](https://github.com/MystenLabs/walrus/tree/main/documentation/examples/javascript)
- [Move smart contracts](https://github.com/MystenLabs/walrus/tree/main/documentation/examples/move)

## Need help?

- [Troubleshooting guide](/usage/troubleshooting.mdx)
