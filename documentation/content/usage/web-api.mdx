...
For special use cases, the [strict consistency check](/design/encoding.mdx#strict-consistency-check)
...
[`list-patches-in-quilt`](/usage/client-cli.mdx#batch-storing-blobs-with-quilt) CLI command.
