...
You should receive an acknowledgement of your report within 48 hours for critical vulnerabilities
and 96 hours for all other vulnerabilities.

If you do not receive a response, contact
[support@hackenproof.com](mailto:support@hackenproof.com). Do not include attachments or provide
detail regarding the security issue.

## Bug Bounty Program

Walrus runs a Bug Bounty Program in partnership with
[HackenProof](https://hackenproof.com/programs/walrus-smart-contracts). Visit the program page for
details on assets in scope, severity levels, bounty amounts, and eligibility.
