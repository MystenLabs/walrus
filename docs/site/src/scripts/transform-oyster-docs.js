...
function generateApiReferencePage() {
  const externalUrl = "https://oyster.testnet.mystenlabs.com/api/docs";
  return `---
    ...
    if (failed) {
      return (
        <div style={{ padding: '2rem', textAlign: 'center' }}>
          ...
          <p><a href="${externalUrl}" target="_blank" rel="noopener noreferrer">Open the API reference in a new tab</a></p>
        </div>
      );
    }
