...
description: Brings the trusted-writer skip_consistency_check option and --skip-consistency-check CLI flag to Mainnet, and removes server_address and server_port...
keywords: ["walrus", "release notes", "changelog", "mainnet", "cli"]
---

**Mainnet** | October 29, 2025
