...
description: Adds a CLI health command and the ability to extend owned blobs with WAL, and lets storage node operators change several...
keywords: ["walrus", "release notes", "changelog", "testnet", "storage node", "cli", "blob"]
---

**Testnet** | January 29, 2025
