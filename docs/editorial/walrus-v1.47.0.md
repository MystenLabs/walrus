...
description: The Testnet preview of storage pool support in the storage node, plus the aggregator's new retryable HTTP 503 BLOB_UNAVAILABLE...
keywords: ["walrus", "release notes", "changelog", "testnet", "storage node", "aggregator", "blob"]
---

**Testnet** | April 22, 2026
