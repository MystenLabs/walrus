...
description: Introduces Quilt, a batch storage solution for storing and accessing many small files efficiently, with new store-quilt,...
keywords: ["walrus", "release notes", "changelog", "testnet", "aggregator", "publisher", "cli", "quilt"]
---

**Testnet** | July 23, 2025
