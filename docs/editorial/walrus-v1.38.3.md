...
description: Delivers significant memory-usage reductions across the aggregator, publisher, and CLI, plus lower upload latency from fewer Sui RPC requests.
keywords: ["walrus", "release notes", "changelog", "mainnet", "aggregator", "publisher", "cli", "blob"]
---
