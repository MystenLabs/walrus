...
description: Makes storage node error responses machine-readable, adds error statuses and richer OpenAPI schemas to the aggregator and publisher, and introduces an...
keywords: ["walrus", "release notes", "changelog", "testnet", "storage node", "aggregator", "publisher", "cli"]
---

**Testnet** | January 23, 2025
