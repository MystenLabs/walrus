...
description: Enables database transactions and garbage collection by default on Testnet, both of which can be turned off in the node...
keywords: ["walrus", "release notes", "changelog", "mainnet", "garbage collection"]
---

**Mainnet** | January 21, 2026
