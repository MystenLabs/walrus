...
description: The Testnet build with major memory-usage reductions across the aggregator, publisher, and CLI and reduced upload latency.
keywords: ["walrus", "release notes", "changelog", "testnet", "aggregator", "publisher", "cli", "blob"]
---

**Testnet** | December 9, 2025
