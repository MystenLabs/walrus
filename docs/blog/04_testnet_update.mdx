...
- Find out how to
  [upload and delete deletable blobs](/walrus-client/storing-blobs.mdx#reclaiming-space-via-deletable-blobs)
  through the CLI.
- Find out more about how [delete operations work](/system-overview/operations#delete).
...
- Find out the [current epoch](/walrus-client/storing-blobs.mdx#walrus-system-information) through the CLI.
- Find out how to store a blob for
  [multiple epochs](/walrus-client/storing-blobs.mdx).
...
Find out how to [request Testnet WAL tokens](/system-overview/available-networks#testnet-wal-faucet) through the CLI.
