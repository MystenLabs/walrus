...
- Find out how to
  [upload and delete deletable blobs](/docs/walrus-client/storing-blobs.mdx#reclaiming-space-via-deletable-blobs)
  through the CLI.
- Find out more about how [delete operations work](/docs/system-overview/operations.mdx#delete).
...
- Find out the [current epoch](/docs/walrus-client/storing-blobs.mdx#walrus-system-information) through the CLI.
- Find out how to store a blob for
  [multiple epochs](/docs/walrus-client/storing-blobs.mdx).
