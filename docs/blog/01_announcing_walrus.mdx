...
operated from the [command line interface](/docs/walrus-client/storing-blobs.mdx), a [JSON API](/docs/walrus-client/json-mode.mdx), and an [HTTP API](/docs/http-api/storing-blobs). We also offer the community an aggregator and
...
The [Walrus Sites website](https://walrus.site), the [Walrus docs](/), and
[this very blog](https://blog.walrus.site) are hosted on Walrus. To learn more about Walrus Sites
and how you can deploy your own, [click here](/docs/sites/introduction/components.mdx).
