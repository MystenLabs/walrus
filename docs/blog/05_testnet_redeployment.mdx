...
- The `walrus` CLI now supports creating, funding, and extending *shared blobs* using the `walrus
  ...
  example of collectively managed and funded blobs. See the [shared blobs section](/docs/walrus-client/storing-blobs.mdx#shared-blobs) for more details.
...
the [JSON API](/docs/walrus-client/json-mode.mdx)).
