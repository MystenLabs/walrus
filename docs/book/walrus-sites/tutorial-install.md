...
| Ubuntu  | Intel 64bit (generic) | [`site-builder-mainnet-latest-ubuntu-x86_64-generic`](https://storage.googleapis.com/mysten-walrus-binaries/site-builder-main-latest-ubuntu-x86_64-generic)|
