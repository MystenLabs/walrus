...
As a next step, you can bring your own domain to the portal. This is useful if you want to use a
custom domain name for your site. Learn how to do this in the [next section][own-domain].
