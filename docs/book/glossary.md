...
| blob                              | single *RedStuff* encoded unstructured data object stored on Walrus                                                                                                                                            |
...
| file                              | a sequence of raw bytes as perceived by the user, the original input                                                                                                           |
...
| quilt patch                       | a single *file* stored in a *quilt*, including the unstructured data and metadata                                                                                                           |
