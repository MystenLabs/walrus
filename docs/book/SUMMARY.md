...
- [Your first Walrus Site](./walrus-sites/tutorial.md)
  - [Local publishing](./walrus-sites/tutorial-local-publishing.md)
    - [Installing the site builder](./walrus-sites/tutorial-install.md)
    - [Publishing a Walrus Site](./walrus-sites/tutorial-publish.md)
  - [Github deployment](./walrus-sites/tutorial-github-deployment.md)
    - [Setting up Github secrets and vars](./walrus-sites/tutorial-gh-secrets-vars.md)
    - [Creating Github workflow](./walrus-sites/tutorial-gh-workflow.md)
