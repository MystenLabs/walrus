...
goal:
  description: Reader can run the sui archival system example and understand the pattern
  requires:
    - pattern: '```'
      min: 3
...
questions:
  ...
  - How it works?
  - What is Sui Archival System in Walrus?
answer: >-
  The Sui Archival application demonstrates how Sui blockchain checkpoint data
  you can archive checkpoint data on Walrus in a reliable, deterministic, and resilient manner.
---
