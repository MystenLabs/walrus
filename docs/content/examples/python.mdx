...
goal:
  description: >-
    Reader can run the using walrus with python example and understand the
    pattern
  requires:
    - pattern: '```'
      min: 3
...
questions:
  - How do I build a using walrus with python on Walrus?
  - How do I use the http api?
  - How do I use the json api?
  - What is Using Walrus with Python in Walrus?
