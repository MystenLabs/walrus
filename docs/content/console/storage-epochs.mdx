...
Storage, epochs, and automatic renewal are all available in the current beta. This page explains how your data's lifetime works and how to avoid losing it. For related cost details, see the [concepts and overview](./overview).
...
Automatic renewal is available in the current beta.
