...
<ImportContent source="app/src/config.ts" mode="code" org="MystenLabs" repo="walrus-console-quickstart" />

<ImportContent source="app/src/lib/seal.ts" mode="code" org="MystenLabs" repo="walrus-console-quickstart" />
...
<ImportContent source="app/src/scripts/sign-reserve.ts" mode="code" org="MystenLabs" repo="walrus-console-quickstart" />
...
<ImportContent source="app/src/scripts/encrypt-file.ts" mode="code" org="MystenLabs" repo="walrus-console-quickstart" />
...
<ImportContent source="app/src/scripts/decrypt-file.ts" mode="code" org="MystenLabs" repo="walrus-console-quickstart" />
