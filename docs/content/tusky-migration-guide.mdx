...
2. Set up a Walrus client
  - Install Walrus [CLI](/docs/walrus-client/storing-blobs) or [SDK](/docs/typescript-sdk/sdks), or use the [web API](/docs/http-api/storing-blobs): https://docs.wal.app/docs/getting-started/index 
