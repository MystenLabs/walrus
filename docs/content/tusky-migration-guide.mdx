...
2. Set up a Walrus client
  - Install Walrus [CLI](/docs/walrus-client/storing-blobs) or [SDK](/typescript-sdk/sdks), or use the [web API](/docs/http-api/storing-blobs): https://docs.wal.app/docs/getting-started/index 

3. Re-upload to Walrus
  - Use the [CLI](/docs/walrus-client/storing-blobs), [SDK](/typescript-sdk/sdks), or [web API](/docs/http-api/storing-blobs).
...
2. Fetch blobs or quilt patches directly from Walrus using:
  ...
  - [Walrus SDKs](/typescript-sdk/sdks)
