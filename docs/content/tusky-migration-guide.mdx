...
2. Set up a Walrus client
  - Install Walrus [CLI](/docs/walrus-client/storing-blobs.mdx) or [SDK](/typescript-sdk/sdks.mdx), or use the [web API](/docs/http-api/storing-blobs.mdx): https://docs.wal.app/docs/getting-started/index 

3. Re-upload to Walrus
  - Use the [CLI](/docs/walrus-client/storing-blobs.mdx), [SDK](/typescript-sdk/sdks.mdx), or [web API](/docs/http-api/storing-blobs.mdx).
...
2. Fetch blobs or quilt patches directly from Walrus using:
  - [Walrus CLI](/docs/walrus-client/storing-blobs.mdx)
  - [Walrus HTTP API](/docs/http-api/storing-blobs.mdx)
