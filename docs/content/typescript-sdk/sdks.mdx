...
For data security, use the [TypeScript SDK](https://www.npmjs.com/package/@mysten/seal) for Seal. It provides threshold encryption and onchain access control for decentralized data protection. To encrypt data before storing it on Walrus, follow the [Encrypt before you store with Seal tutorial](/docs/typescript-sdk/seal-encryption-tutorial). Also, refer to [data security](/docs/data-security) for details.
