---
title: Verifying Blob Integrity
description: Verify blob integrity using the Walrus TypeScript SDK.
keywords: [ walrus, typescript, sdk, integrity, verification, hash, certificate, blob, error ]
---
