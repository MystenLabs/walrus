...
If successful, the console responds with the information stored in the content of the blob's corresponding [Sui object](/system-overview/core-concepts).
:
...
The field `event` returns the [Sui event ID](/system-overview/core-concepts) that can be used to find the object creation transaction using a [Sui Explorer](https://suiscan.xyz/) or using a [Sui SDK](https://docs.sui.io/references/sui-sdks).
