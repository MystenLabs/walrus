...
keywords:
  ...
  - aggregator
goal:
  description: Reader can look up quilt http apis details
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  ...
  - >-
    Store and retrieve multiple blobs as a single quilt using the Walrus HTTP
    API, including quilt storage, patch IDs, and retrieval by identifier.?
  - How does quilt http apis work?
answer: >-
  Store and retrieve multiple blobs as a single quilt using the Walrus HTTP API,
  including quilt storage, patch IDs, and retrieval by identifier.
---
