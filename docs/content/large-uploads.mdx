...
keywords:
  ...
  - ingestion pipeline
goal:
  description: Reader understands large data upload workarounds and can apply the concepts
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Large Data Upload Workarounds in Walrus?
  - How do I use local tooling for upload observability?
answer: >-
  The maximum blob size on Walrus is approximately 13.6 GiB. Uploading large
  data sets or individual blobs larger than 1 GiB require certain workarounds
  and planning for optimal performance and efficiency.
---
