...
The strength of the authentication guarantee depends on how much you trust the portal you use to browse a Walrus Site. There are 3 deployment types, each offering a different level of confidence.
...
The following table summarizes the trust requirements for each deployment type:
