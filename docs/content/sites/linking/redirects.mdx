...
description: How redirects work in Walrus Sites, including routing-based internal redirects, HTTP redirects, and redirecting arbitrary Sui objects to a Walrus Site.
keywords: [Walrus Sites, redirects, routing, ws-resources.json, Display, NFT, object redirect, SPA, single-page application, 3xx, HTTP redirect]
---
