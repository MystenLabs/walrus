...
description: How redirects work in Walrus Sites, including routing-based internal redirects, redirecting arbitrary Sui objects to a Walrus Site, and the limitations of dynamic redirects.
keywords: [Walrus Sites, redirects, routing, ws-resources.json, Display, NFT, object redirect, SPA, single-page application]
---
