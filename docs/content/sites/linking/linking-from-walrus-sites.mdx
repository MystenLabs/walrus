...
description: How to link from Walrus Sites to external URLs, including absolute URL requirements, resource loading, and common outbound linking patterns.
keywords: [Walrus Sites, external links, absolute URL, navigation, anchor, CORS]
---

Walrus Sites serves content stored on Walrus through a portal. All relative URLs in your site resolve against the on-chain site object. Anything outside that object, such as third-party pages, APIs, CDN assets, other Walrus Sites, requires an absolute URL.
