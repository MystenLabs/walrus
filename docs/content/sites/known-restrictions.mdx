...
keywords:
  ...
  - routing
goal:
  description: Reader understands known restrictions and can apply the concepts
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Known Restrictions in Walrus?
answer: >-
  Walrus Sites can be used to deploy almost any form of traditional static Web2
  website built for modern browsers.
---
