...
description: >-
  A comprehensive reference of known restrictions and limitations when developing and deploying Walrus Sites.
keywords:
  - walrus sites
  - restrictions
  - limitations
...
[This claim should be removed or corrected as it contradicts PAGE A which states sites can be accessed by Base36 object ID on Mainnet without SuiNS domains] Shared-origin access is not supported.
