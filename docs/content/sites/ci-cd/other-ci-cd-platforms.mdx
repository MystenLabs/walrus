...
description: "How to automate Walrus Sites deployment on GitLab CI/CD, CircleCI, Bitbucket Pipelines, and any other CI/CD platform using the site-builder CLI directly."
keywords: ["walrus sites", "ci/cd", "gitlab", "circleci", "bitbucket pipelines", "deployment automation", "site-builder", "pipeline"]
---
...
2. **Download `site-builder`:** Fetch the binary for the runner's architecture from the Mysten Labs GCS bucket.
3. **Download `sites-config.yaml`:** Fetch the network configuration from the walrus-sites repository.
