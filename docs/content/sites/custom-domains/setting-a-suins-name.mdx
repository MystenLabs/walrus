...
- [x] Access to [suins.io](https://suins.io) (Mainnet) or [testnet.suins.io](https://testnet.suins.io) (Testnet)
</TabItem>
</Tabs>
</div>
...
A SuiNS name is an on-chain name registered on the Sui blockchain. When you link a SuiNS name to a Walrus Site, you set the Walrus Site object ID on the SuiNS name record. The `wal.app` portal reads that record and routes visitors to your site's content.
