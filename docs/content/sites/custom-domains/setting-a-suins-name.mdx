...
questions:
  - How do I set a SuiNS name for a Walrus Site?
  - How do I register a human-readable URL for my Walrus Site?
  - What is the connection between SuiNS and Walrus Sites?
answer: >-
  Complete guide to registering a SuiNS name and linking it to a Walrus Site for
  human-readable URLs on the wal.app portal.
---
