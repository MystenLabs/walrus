...
description: "Complete guide to registering a SuiNS name and linking it to a Walrus Site for human-readable URLs on the wal.app portal."
keywords: ["walrus sites", "suins", "domain names", "naming", "portal", "sui blockchain", "human readable", "custom domain"]
---
...
- [x] A deployed Walrus Site with a known object ID
- [x] A Sui-compatible wallet funded with SUI to pay for the SuiNS name registration and transaction fees
</TabItem>
</Tabs>
</div>
...
A SuiNS name is an on-chain name registered on the Sui blockchain. When you link a SuiNS name to a Walrus Site, the `wal.app` portal reads the on-chain record and routes visitors to your site's content.
...
To link a SuiNS name to your Walrus Site, you need the site's object ID. This is the on-chain identifier for the Walrus Site object.
...
```
New site object ID: 0x1234...abcd
```

You can also find the object ID by searching your wallet address in [Sui Explorer](https://suiexplorer.com) and locating the Walrus Site object in your owned objects.
...
You can update the Walrus Site your SuiNS name points to at any time. This is useful when you redeploy a site and receive a new object ID.
