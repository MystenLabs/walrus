...
keywords:
  ...
  - custom domain
goal:
  description: Reader understands setting a suins name and can apply the concepts
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Setting a SuiNS Name?
  - >-
    Complete guide to registering a SuiNS name and linking it to a Walrus Site
    for human-readable URLs on the wal.?
  - How does setting a suins name work?
answer: >-
  Complete guide to registering a SuiNS name and linking it to a Walrus Site for
  human-readable URLs on the wal.app portal.
---
