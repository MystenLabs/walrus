...
keywords: ["walrus sites", "custom domain", "dns configuration", "portal setup", "domain registration", "hosting", "bring your own domain"]
---
...
- [x] The Walrus Sites portal repository cloned and set up locally, per [Deploy a Local Portal](/docs/sites/portals/deploy-locally)
</TabItem>
</Tabs>
</div>
