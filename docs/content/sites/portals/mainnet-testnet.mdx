...
keywords:
  ...
  - SuiNS
goal:
  description: Reader understands configure a local sites portal and can apply the concepts
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I configure a Walrus Sites portal for Mainnet or Testnet?
  - What portal configuration is needed for different networks?
  - How do I switch my portal between Testnet and Mainnet?
answer: >-
