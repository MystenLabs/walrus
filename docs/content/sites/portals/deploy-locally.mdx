...
keywords:
  ...
  - bun
goal:
  description: Reader understands deploy a local portal and can apply the concepts
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I deploy a local Walrus Sites portal?
  - How do I test a Walrus Site locally before deploying?
  - What is a Walrus Sites portal?
