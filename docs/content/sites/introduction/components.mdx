...
description: "A Walrus Site consists of data stored as blobs on Walrus, a site object on Sui that maps resource paths to blob IDs, the site-builder CLI for publishing and updating, a ws-resources.json configuration file, and a portal that resolves and serves the site to browsers."
