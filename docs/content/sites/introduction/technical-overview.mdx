...
The `wal.app` portal does not support Base36 domain resolution. https://58gr4pinoayuijgdixud23441t55jd94ugep68fsm72b8mwmq2.wal.app is not a valid URL. If you want to access such a site, you should either use another portal or [host your own](/sites/portals/deploy-locally#running-a-local-portal).
...
To facilitate the creation of Walrus Sites, the `site-builder` tool is provided. The `site-builder` takes care of creating Walrus Sites object on Sui, with the correct structure, and stores the site resources to Walrus. Refer to the [tutorial](/docs/sites/index) for setup and usage instructions.
