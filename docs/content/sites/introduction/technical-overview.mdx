...
<iframe src="/diagrams/interactive_walrus-sites-request_v1.html" style={{width:'100%',height:'560px',border:'0'}} title="Walrus Sites request path" loading="lazy"></iframe>
