...
To facilitate the creation of Walrus Sites, the `site-builder` tool is provided. The `site-builder` takes care of creating Walrus Sites object on Sui, with the correct structure, and stores the site resources to Walrus. Refer to the [tutorial](/sites.mdx) for setup and usage instructions.
