...
keywords:
  ...
  - publish
goal:
  description: Reader understands site builder reference and can apply the concepts
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Site Builder Reference in Walrus?
answer: >-
  This reference page provides details on `site-builder` configuration and CLI
  commands.
---
