...
More details on the configuration of the `site-builder` can be found under the [advanced configuration](/docs/sites/configuration/configuration-file-reference) section.
