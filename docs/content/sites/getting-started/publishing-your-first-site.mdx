...
More details on the configuration of the `site-builder` can be found in the [advanced configuration](/docs/sites/getting-started/installing-the-site-builder#configuration) section.
