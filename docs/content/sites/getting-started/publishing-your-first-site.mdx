...
keywords:
  ...
  - examples
goal:
  description: Reader understands deploy a walrus site and can apply the concepts
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I publish my first Walrus Site?
  - How do I deploy a static site to Walrus?
  - What does the site-builder publish command do?
answer: >-
  Tutorial for publishing, viewing, and updating your first Walrus Site using
  the site-builder tool with example projects.
---
