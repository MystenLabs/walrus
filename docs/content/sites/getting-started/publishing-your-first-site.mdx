...
- The URLs where you can browse the site. Because wal.app only supports sites deployed on Mainnet, a Testnet site is reachable through the printed local portal URL once you self-host a portal.
...
```sh
$ site-builder --context=testnet deploy --object-ids 0x617221edd060dafb4070b73160ebf535e1516bf7f246890ed35190eba786d7ac --epochs 1 ./walrus-snake
```
...
If you are building a Walrus Site using a web framework (such as Vite, Create React App, Next.js, Vue CLI, or Docusaurus), ensure
