...
draft: false
goal:
  description: Reader understands specifying http headers and can apply the concepts
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  ...
  - Guide to specifying custom HTTP response headers.?
  - How does specifying http headers work?
