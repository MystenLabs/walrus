...
draft: false
goal:
  description: Reader understands adding metadata and can apply the concepts
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Adding Metadata?
  - Reference page for adding metadata to a Walrus Site.?
  - How does adding metadata work?
