...
keywords:
  ...
  - spa
goal:
  description: Reader understands site configuration and can apply the concepts
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  ...
  - Guide to using ws-resources.?
  - How does site configuration work?
answer: >-
  In its base configuration, a Walrus Site serves static assets through a
  portal.
---
