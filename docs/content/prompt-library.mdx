...
description: "Copy-paste prompts that exercise the core task of each Walrus skill, from installing the CLI to deploying a site."
keywords: ["walrus", "skills", "prompts", "agents", "coding agent", "cli", "sites"]
---
