...
Walrus uses a bespoke erasure code construction called RedStuff, based on efficiently computable Reed-Solomon codes. For complete technical details, see the [Walrus whitepaper](/docs/walrus.pdf). This page summarizes some of the basic techniques and terminology used by Walrus.
