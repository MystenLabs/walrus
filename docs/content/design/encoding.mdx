...
For [quilt patches](/system-overview/quilt.mdx), only a variant of the default consistency check is available, because clients read only part of the quilt rather than the entire structure.
