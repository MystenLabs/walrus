...
App builders may use Walrus in conjunction with any L1 or L2 blockchains to build experiences that require large amounts of data to be stored, and possibly certified as available, in a decentralized manner.
