...
**Users** [interact with Walrus](/walrus-client/storing-blobs.mdx) through **clients** to store and read **blobs**, which are identified by their **blob ID**. Users engage with the system in two primary ways:
