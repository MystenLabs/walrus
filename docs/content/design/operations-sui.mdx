...
The availability event marks the [point of availability](/design/properties) for the blob, after which Walrus guarantees its availability for the specified duration.
