...
keywords:
  ...
  - advanced setup
goal:
  description: Reader can advanced installation and verify the result
  requires:
    - pattern: '```'
      min: 2
...
questions:
  - How do I advanced installation?
  - How do I install through script nix-install?
  - How do I install on windows windows-install?
  - How do I install through cargo?
answer: >-
  Advanced installation options for Walrus including building from source and
  binary installation.
---
