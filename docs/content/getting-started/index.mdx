...
Sui and Walrus each have the following available [networks](/system-overview/available-networks.mdx):
...
[Build your first Walrus application](/docs/getting-started/index.mdx). Explore working examples:
