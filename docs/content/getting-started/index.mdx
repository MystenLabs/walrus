...
keywords:
  ...
  - setup
goal:
  description: Reader can getting started with walrus and verify the result
  requires:
    - pattern: '```'
      min: 2
...
questions:
  - How do I get started with Walrus?
  - What is Walrus and how does it work?
  - How do I install the Walrus CLI?
answer: >-
  Walrus is a verifiable data platform for high-stakes systems like AI and
  onchain finance, where data is stored as blobs.
---
