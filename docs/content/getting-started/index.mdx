...
Sui and Walrus each have the following available [networks](/system-overview/available-networks):
...
The system uploads a blob in slivers, which are small pieces of the file the system stores on different servers through erasure coding. [Learn more](/design/encoding) about the Walrus architecture and how the system implements erasure coding.
...
[Build your first Walrus application](/docs/getting-started/index). Explore working examples:
