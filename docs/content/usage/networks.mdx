...
Many other parameters, including the system capacity and prices, are dynamic. Such parameters are stored in the [system object](/docs/dev-guide/sui-struct.mdx#system-and-staking-information) and can be viewed with tools like the [Walruscan explorer](https://walruscan.com/).
...
The configuration file described on the [setup page](/usage/started.mdx) includes both Mainnet and Testnet configuration.
...
- [x] Download and install the [Sui CLI](/docs/usage/started.mdx#step-1-install-tooling).

- [x] Create a [Sui account](/docs/usage/started.mdx#step-3-understanding-your-sui-account).

- [x] Obtain [Testnet SUI](/docs/usage/started.mdx#step-4-fund-sui-account-with-tokens).
...
The configuration parameters for the Walrus Testnet are included in the configuration file described on the [getting started guide](/docs/usage/started.mdx#step-2-configure-tooling-for-walrus-testnet). If you want only the Testnet configuration, you can get the Testnet-only configuration file. The parameters are:
...
The script generates configuration that you can use when [running the Walrus client](/usage/client-cli.mdx) and prints the path to that configuration file.
