...
keywords:
  ...
  - consistency check
goal:
  description: Reader understands reading blobs and can apply the concepts
  requires:
    - has_frontmatter:
        - title
        - description
...
answer: 'You can query the status of a blob through one of the following commands:.'
---
