...
keywords:
  ...
  - monitoring
goal:
  description: Reader understands managing blobs and can apply the concepts
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Managing Blobs?
  - >-
    Use the Walrus client to check, extend, delete, burn, share, and set
    attributes on blobs across their lifecycle.?
  - How does managing blobs work?
answer: Use the Walrus client to manage blobs and their metadata.
---
