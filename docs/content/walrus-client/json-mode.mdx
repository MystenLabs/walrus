...
keywords:
  ...
  - scripting
goal:
  description: Reader understands json mode and can apply the concepts
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is JSON Mode in Walrus?
answer: >-
  All Walrus client commands are available in JSON mode, which simplifies
  programmatic access to the [CLI](/docs/walrus-client/storing-blobs).
---
