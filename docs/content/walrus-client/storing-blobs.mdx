...
<AgentPrompt
  prompt="Store a file on Walrus using the CLI for 53 epochs. Show me how to set the storage duration, choose between deletable and permanent, and store multiple files at once."
/>
