...
<AgentPrompt
  prompt="I have 400 small JSON files in ./records/. Store them as a quilt for 53 epochs, then show me how to read back individual files by name without downloading the entire quilt."
/>
