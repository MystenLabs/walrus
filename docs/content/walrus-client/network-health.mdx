...
A 24% shard outage on a 1,000-shard network illustrates the middle case: 1000 shards stay healthy against a threshold of 667, so writes still certify, with 93 shards of margin. That is why the failures look intermittent rather than total.
