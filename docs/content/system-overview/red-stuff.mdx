...
keywords:
  ...
  - Twin-Code
goal:
  description: Reader understands redstuff encoding algorithm and can apply the concepts
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  ...
  - >-
    Learn how the RedStuff encoding algorithm works in Walrus, including erasure
    coding, RaptorQ fountain codes, sliver encoding, recovery, and blob
    metadata.?
  - How does redstuff encoding algorithm work?
answer: >-
  The RedStuff encoding algorithm used in Walrus is an adaptation of the
  Twin-Code framework presented by Rashmi et al. <a
  href="https://doi.org/10.1109/ISIT.2011.6033732">[1]</a>.
---
