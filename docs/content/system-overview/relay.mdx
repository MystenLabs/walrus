---
title: Upload Relay
description: Learn how the Walrus upload relay simplifies blob uploads by batching requests, handling retries, and generating certificates on behalf of your application.
keywords: [ walrus, typescript, sdk, relay, upload, batching, reliability, certificate, retry ]
---
