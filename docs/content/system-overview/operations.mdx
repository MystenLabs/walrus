...
<iframe src="/diagrams/interactive_write-read-lifecycle_v1.html" style={{width:'100%',height:'560px',border:'0'}} title="Walrus write and read lifecycle" loading="lazy"></iframe>
