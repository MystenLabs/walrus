...
goal:
  description: Reader understands operations and can apply the concepts
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Operations in Walrus?
answer: >-
  Blobs can be interacted with through familiar file system operations such as
  uploading, reading, downloading, and deleting.
---
