...
keywords:
  ...
  - events
goal:
  description: Reader understands walrus fundamentals and can apply the concepts
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What are the core concepts of Walrus?
  - How does Walrus store data as blobs?
  - What infrastructure does Walrus use?
answer: >-
  Data is stored on Walrus as blobs. Each blob is an immutable array of bytes.
  Any type of file, such as text, video, or source code, can be stored on
  Walrus. All blobs uploaded to Walrus are publicly available.
---
