...
1. WAL for the storage operation. You can learn more about the [WAL tokenomics](https://www.walrus.xyz/wal-token) and the role WAL plays in the [Walrus delegated proof of stake system](/docs/walrus.pdf).
