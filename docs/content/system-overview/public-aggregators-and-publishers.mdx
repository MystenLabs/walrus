...
goal:
  description: >-
    Reader understands public aggregators and publishers and can apply the
    concepts
  requires:
    - has_frontmatter:
        - title
...
questions:
  ...
  - How does public aggregators and publishers work?
  - What is Using a public aggregator or publisher?
answer: >-
  The Walrus client offers a daemon mode that runs a simple web server that
  provides HTTP interfaces you can use to store and read blobs in an aggregator
  or publisher role respectively.
---
