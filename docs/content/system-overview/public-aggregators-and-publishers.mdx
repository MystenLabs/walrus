...
Most aggregators and publishers limit requests to 10 MB by default. If you want to upload larger files, you need to [run your own publisher](/operator-guide/aggregator.mdx#local-daemon) or use the [CLI](/docs/walrus-client/storing-blobs.mdx).
