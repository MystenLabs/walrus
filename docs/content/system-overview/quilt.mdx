...
keywords:
  ...
  - quilt patch id
goal:
  description: Reader understands batch storage with quilt and can apply the concepts
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  ...
  - >-
    Comprehensive guide to Walrus Quilt for batch storage of multiple small
    blobs with cost optimization and metadata management.?
answer: >-
  Comprehensive guide to Walrus Quilt for batch storage of multiple small blobs
  with cost optimization and metadata management.
---
