...
The script generates configuration that you can use when [running the Walrus client](/walrus-client/storing-blobs.mdx) and prints the path to that configuration file.
