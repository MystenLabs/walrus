...
keywords:
  ...
  - operations
goal:
  description: Operator can operate an aggregator following the documented procedure
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  ...
  - How do I start a local daemon local-daemon?
  - What is Operate an Aggregator?
answer: >-
