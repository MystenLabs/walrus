...
description: "Request size limits, nginx caching configuration, and daemon metrics for Walrus aggregators and publishers."
keywords: ["walrus", "publisher", "aggregator", "nginx", "caching", "metrics", "limitations"]
---
