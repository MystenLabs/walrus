...
goal:
  description: Operator can slashing walkthrough following the documented procedure
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How does slashing work on Walrus Mainnet?
  - What happens during a Walrus slashing event?
  - How do I execute slashing vote and cleanup commands?
answer: >-
  A worked example of a slashing event on Mainnet, with the concrete vote,
  execute, and cleanup commands operators run end to end.
---
