...
keywords:
  ...
  - contract upgrades
goal:
  description: Operator can commission and governance following the documented procedure
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I manage storage node commission rates?
  - How does governance work for Walrus storage nodes?
  - How do I authorize contract upgrades?
answer: >-
  Manage storage node commission collection and governance operations including
  authorization and contract upgrades.
---
