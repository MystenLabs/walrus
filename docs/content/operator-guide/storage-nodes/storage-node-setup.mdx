...
keywords:
  ...
  - jemalloc
goal:
  description: Operator can set up a storage node following the documented procedure
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I set up a Walrus storage node?
  - What are the hardware requirements for a storage node?
  - How do I register my storage node on the network?
answer: >-
  Step-by-step guide for setting up a Walrus storage node, including system
  preparation, TLS, configuration, and registration.
---
