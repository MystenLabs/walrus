...
questions:
  - How do you operate an upload relay?
  - How do you install the relay?
  - How do you configure the relay?
answer: >-
  Guide to operating Walrus upload relays for facilitating browser-based blob
  storage with tip configuration and payment systems.
---
...
<iframe src="/diagrams/interactive_upload-relay-flow_v1.html" style={{width:'100%',height:'1150px',border:'0'}} title="Upload relay flow" loading="lazy"></iframe>
