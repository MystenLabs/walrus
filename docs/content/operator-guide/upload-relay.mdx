...
- `$HOME/.config/walrus/client_config.yaml` exists on the host machine and contains Walrus client configuration as specified [in the CLI setup section](/docs/getting-started/advanced-setup.mdx#configuration).
