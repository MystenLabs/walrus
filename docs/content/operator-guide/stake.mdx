...
keywords:
  ...
  - dapp
goal:
  description: Operator can staking and unstaking following the documented procedure
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I stake and unstake WAL tokens?
  - How do I delegate WAL to a storage node?
  - What is the Walrus staking app?
answer: >-
  Complete guide to staking and unstaking WAL tokens with storage nodes using
  the Walrus staking app.
---
