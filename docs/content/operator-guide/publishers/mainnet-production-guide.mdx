...
goal:
  description: >-
    Operator can mainnet publisher production guide following the documented
    procedure
  requires:
    - has_frontmatter:
        - title
...
questions:
  ...
  - What is Mainnet Publisher Production Guide?
  - Production guidance for running private Mainnet publishers on Walrus.?
