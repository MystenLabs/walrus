...
slug: /operator-guide/auth-publisher
description: "Detailed guide for configuring and operating the Walrus authenticated publisher with JWT-based access control."
