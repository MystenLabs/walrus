...
keywords:
  ...
  - integrity
goal:
  description: Reader understands data security and can apply the concepts
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  ...
  - >-
    Security guarantees and best practices for Walrus including data
    availability and integrity.?
  - How does data security work?
answer: >-
  Walrus provides decentralized storage for application and user data. All data
  stored on Walrus is public and can be accessed by anyone.
---
