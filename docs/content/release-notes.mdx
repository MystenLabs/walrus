...
goal:
  description: Reader understands release notes and can apply the concepts
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Release Notes in Walrus?
answer: >-
  Release notes from [Walrus](https://github.com/MystenLabs/walrus/releases) and
