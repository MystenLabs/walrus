...
keywords:
  ...
  - retry
goal:
  description: Reader can diagnose and fix common reading blobs right after upload issues
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - When this applies?
  - What is Reading Blobs Right After Upload?
  - >-
    Why blobs might return 404 immediately after certification when using a
    cached aggregator, and how to handle the propagation window.?
answer: >-
  Why blobs might return 404 immediately after certification when using a cached
  aggregator, and how to handle the propagation window.
---
