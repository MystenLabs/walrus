...
module bucket_object::bucket_object_registry;

use bucket_object::bucket_object::{Self as bucket_object, BucketObject};
...
public fun new(blob_bucket_id: ID, ctx: &mut TxContext): ID {
    let registry = new_for_testing(blob_bucket_id, ctx);
