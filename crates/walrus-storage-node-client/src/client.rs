...
use walrus_core::{
    ...
    ShardIndex, Sliver, SliverIndex, SliverPairIndex, SliverType, SymbolId,
    encoding::{
        EncodingAxis, EncodingConfig, GeneralRecoverySymbol, Primary, RecoverySymbol, Secondary,
        SliverData,
    },
    ...
    merkle::MerkleProof,
    messages::{
        BlobPersistenceType, InvalidBlobIdAttestation, SignedStorageConfirmation,
        StorageConfirmation, SyncShardMsg, SyncShardRequest, SyncShardResponse,
    },
