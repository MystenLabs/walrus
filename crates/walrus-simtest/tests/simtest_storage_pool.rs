...
mod tests {
    ...
    /// certifies it on-chain, and returns the blob ID and PoolBlob object ID.
    async fn store_blob_in_bucket(
        ...
        let blob_obj_id: ObjectID = sui_client
            .register_pool_blob(bucket_id, blob_metadata, persistence)
            .await
        ...
        sui_client
            .certify_pool_blob(bucket_id, blob_id, &certificate)
            .await
    ...
    /// and `object_id` is the PoolBlob's Sui object ID.
    async fn list_blob_ids_in_bucket(
        ...
        loop {
            ...
            for entry in &page.data {
                ...
                // For ObjectTable, entry.object_id is the PoolBlob's Sui object ID.
    ...
    async fn test_storage_pool_operations() {
        ...
        sui_client
            .delete_pool_blob(bucket1_id, blob1_id)
            .await
    ...
    async fn test_storage_pool_list_blobs() {
        ...
        sui_client
            .delete_pool_blob(bucket_id, blob2_id)
            .await
