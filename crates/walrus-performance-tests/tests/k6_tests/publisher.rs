...
mod blob {
    ...
    walrus_test_utils::param_test! {
        blob_upload_latency -> TestResult: [
            payload_1ki: (ByteSize::kibi(1), 3, 1),
            payload_100ki: (ByteSize::kibi(100), 3, 1),
            payload_1mi: (ByteSize::mebi(1), 3, 1),
            payload_10mi: (ByteSize::mebi(10), 3, 1),
            payload_100mi: (ByteSize::mebi(100), 3, 1),
            payload_200mi: (ByteSize::mebi(200), 3, 1),
            payload_300mi: (ByteSize::mebi(300), 3, 1),
            payload_400mi: (ByteSize::mebi(400), 3, 1),
