...
pub fn create_client(rpc_url: &str, auth_config: &RpcAuthConfig) -> anyhow::Result<Arc<RpcClient>> {
...
pub fn create_client_with_env_auth(rpc_url: &str) -> anyhow::Result<Arc<RpcClient>> {
