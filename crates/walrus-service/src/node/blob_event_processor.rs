...
impl BlobEventProcessor {
    ...
    pub(super) async fn process_storage_pool_event(
        ...
        match event {
            StoragePoolEvent::Created(ref created) => {
                self.node
                    .storage
            ...
            StoragePoolEvent::BlobRegistered(ref registered) => {
                self.node
                    .storage
                    .process_pool_blob_registered(event_handle.index(), registered)
                    .context("failed to process pool blob registered")?;
            ...
            StoragePoolEvent::BlobCertified(ref certified) => {
                self.node
                    .storage
                    .process_pool_blob_certified(event_handle.index(), certified)
                    .context("failed to process pool blob certified")?;
            ...
            StoragePoolEvent::BlobDeleted(ref deleted) => {
                self.node
                    .storage
                    .process_pool_blob_deleted(event_handle.index(), deleted)
                    .context("failed to process pool blob deleted")?;
            ...
            StoragePoolEvent::Extended(ref extended) => {
                self.node
                    .storage
