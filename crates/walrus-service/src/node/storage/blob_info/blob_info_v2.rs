...
// Important: This struct MUST NOT be changed. Instead, if needed, a new `ValidBlobInfoV3` struct
// should be created.
...
pub(crate) struct ValidBlobInfoV2 {
    ...
    pub permanent_total: Option<PermanentBlobInfoV2>,
    pub permanent_certified: Option<PermanentBlobInfoV2>,
...
impl ValidBlobInfoV2 {
    ...
    /// Processes a register status change on the [`Option<PermanentBlobInfoV2>`] object
    /// representing all permanent blobs.
    fn register_permanent(
        permanent_total: &mut Option<PermanentBlobInfoV2>,
        change_info: &BlobStatusChangeInfo,
    ) {
        PermanentBlobInfoV2::update_optional(permanent_total, change_info)
    }

    /// Processes a certify status change on the [`PermanentBlobInfoV2`] objects representing all
    /// and the certified permanent blobs.
    ///
    /// Returns whether the update was successful.
    fn certify_permanent(
        permanent_total: &Option<PermanentBlobInfoV2>,
        permanent_certified: &mut Option<PermanentBlobInfoV2>,
        change_info: &BlobStatusChangeInfo,
    ) -> bool {
        ...
        PermanentBlobInfoV2::update_optional(permanent_certified, change_info);
        true
    }

    /// Processes an extend status change on the [`PermanentBlobInfoV2`] object representing the
    /// certified permanent blobs.
    fn extend_permanent(
        permanent_info: &mut Option<PermanentBlobInfoV2>,
        change_info: &BlobStatusChangeInfo,
    ) {
    ...
    /// Processes a delete status change on the [`PermanentBlobInfoV2`] objects representing all and
    ...
    fn decrement_blob_info_inner(blob_info_inner: &mut Option<PermanentBlobInfoV2>) {
        match blob_info_inner {
            None => tracing::error!("attempt to delete a permanent blob when none is tracked"),
            Some(PermanentBlobInfoV2 { count, .. }) => {
                if count.get() == 1 {
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub(crate) struct PermanentBlobInfoV2 {
...
impl PermanentBlobInfoV2 {
    /// Creates a new `PermanentBlobInfoV2` object for the first blob with the given `end_epoch` and
    /// `event`.
    ...
    fn update_optional(existing_info: &mut Option<Self>, change_info: &BlobStatusChangeInfo) {
        ...
        match existing_info {
            None => {
                *existing_info = Some(PermanentBlobInfoV2::new_first(
                    *new_end_epoch,
                    *new_status_event,
                ))
            }
        ...
        match operand {
            BlobInfoMergeOperand::ChangeStatus {
                ...
                if deletable {
                    ...
                    ValidBlobInfoV2 {
                        permanent_total: Some(PermanentBlobInfoV2::new_first(
                            end_epoch,
                            status_event,
                        )),
                        ..Default::default()
...
mod tests {
    ...
    fn check_invariants(blob_info: &BlobInfoV2) {
        if let BlobInfoV2::Valid(valid_blob_info) = blob_info {
            valid_blob_info
                .check_invariants()
    ...
    fn test_merge_new_expected_failure_cases(operand: BlobInfoMergeOperand) {
        let _ = BlobInfoV2::merge_new(operand);
    }
    ...
    param_test! {
        test_mark_metadata_stored_keeps_everything_else_unchanged: [
            ...
            deletable: (ValidBlobInfoV2{count_deletable_total: 2, ..Default::default()}),
            ...
            permanent: (ValidBlobInfoV2{
                permanent_total: Some(PermanentBlobInfoV2::new_fixed_for_testing(2, 3, 0)),
                ..Default::default()
            }),
            permanent_certified: (ValidBlobInfoV2{
                permanent_total: Some(PermanentBlobInfoV2::new_fixed_for_testing(2, 3, 0)),
                permanent_certified: Some(PermanentBlobInfoV2::new_fixed_for_testing(1, 2, 0)),
    ...
    fn test_mark_metadata_stored_keeps_everything_else_unchanged(
        ...
        let expected_updated_info = ValidBlobInfoV2 {
            is_metadata_stored: true,
        ...
        let updated_info = BlobInfoV2::Valid(preexisting_info)
    ...
    fn test_mark_invalid_marks_everything_invalid(preexisting_info: ValidBlobInfoV2) {
        ...
        assert_eq!(BlobInfoV2::Invalid { epoch: 2, event }, updated_info);
    }
    ...
    param_test! {
        test_merge_preexisting_expected_successes: [
            ...
            register_first_permanent: (
                ...
                ValidBlobInfoV2{
                    permanent_total: Some(PermanentBlobInfoV2::new_fixed_for_testing(1, 2, 0)),
                    ..Default::default()
                },
            ),
            extend_deletable: (
            ...
            extend_permanent: (
                ValidBlobInfoV2{
                    initial_certified_epoch: Some(0),
                    permanent_total: Some(PermanentBlobInfoV2::new_fixed_for_testing(2, 4, 0)),
                    permanent_certified: Some(PermanentBlobInfoV2::new_fixed_for_testing(1, 4, 1)),
                    ..Default::default()
                },
                BlobInfoMergeOperand::new_change_for_testing(
                ...
                ValidBlobInfoV2{
                    initial_certified_epoch: Some(0),
                    permanent_total: Some(PermanentBlobInfoV2::new_fixed_for_testing(2, 42, 2)),
                    permanent_certified: Some(PermanentBlobInfoV2::new_fixed_for_testing(1, 42, 2)),
                    ..Default::default()
                },
            ),
            ...
            certify_outdated_permanent: (
                ValidBlobInfoV2{
                    ...
                    permanent_total: Some(PermanentBlobInfoV2::new_fixed_for_testing(2, 42, 0)),
                    permanent_certified: Some(PermanentBlobInfoV2::new_for_testing(1, 5)),
                    ..Default::default()
                },
                BlobInfoMergeOperand::new_change_for_testing(
                ...
                ValidBlobInfoV2{
                    ...
                    permanent_total: Some(PermanentBlobInfoV2::new_fixed_for_testing(2, 42, 0)),
                    permanent_certified: Some(PermanentBlobInfoV2::new_fixed_for_testing(2, 42, 1)),
                    ..Default::default()
                },
            ),
            register_additional_permanent: (
                ...
                ValidBlobInfoV2{
                    permanent_total: Some(PermanentBlobInfoV2::new_fixed_for_testing(2, 3, 1)),
                    ..Default::default()
                },
            ),
            expire_permanent_blob: (
                ValidBlobInfoV2{
                    permanent_total: Some(PermanentBlobInfoV2::new_fixed_for_testing(3, 5, 0)),
                    permanent_certified: Some(PermanentBlobInfoV2::new_fixed_for_testing(2, 5, 1)),
                    initial_certified_epoch: Some(1),
                    ..Default::default()
                },
                BlobInfoMergeOperand::PermanentExpired {
                ...
                ValidBlobInfoV2{
                    permanent_total: Some(PermanentBlobInfoV2::new_fixed_for_testing(2, 5, 0)),
                    permanent_certified: Some(PermanentBlobInfoV2::new_fixed_for_testing(1, 5, 1)),
                    initial_certified_epoch: Some(1),
                    ..Default::default()
                },
            ),
            expire_last_permanent_blob: (
                ...
                ValidBlobInfoV2{
                    permanent_total: Some(PermanentBlobInfoV2::new_fixed_for_testing(1, 5, 0)),
                    permanent_certified: None,
                    initial_certified_epoch: None,
                    ..Default::default()
                },
    ...
    fn test_merge_preexisting_expected_successes(
        ...
        let updated_info = BlobInfoV2::Valid(preexisting_info).merge_with(operand);
    ...
    fn test_merge_preexisting_expected_failures(
        ...
        preexisting_info
            .check_invariants()
            .expect("preexisting blob info invariants violated");
        let preexisting_info = BlobInfoV2::Valid(preexisting_info);
    ...
    param_test! {
        test_blob_status_is_inexistent_for_expired_blobs: [
            ...
            expired_permanent_certified: (
                ValidBlobInfoV2 {
                    permanent_total: Some(PermanentBlobInfoV2::new_fixed_for_testing(2, 2, 0)),
                    permanent_certified: Some(PermanentBlobInfoV2::new_fixed_for_testing(1, 2, 0)),
                    ..Default::default()
                },
                1,
    ...
    fn test_blob_status_is_inexistent_for_expired_blobs(
        blob_info: ValidBlobInfoV2,
        epoch_not_expired: Epoch,
        epoch_expired: Epoch,
    ) {
        assert_ne!(
            BlobInfoV2::Valid(blob_info.clone()).to_blob_status(epoch_not_expired),
            BlobStatus::Nonexistent,
        );
        assert_eq!(
            BlobInfoV2::Valid(blob_info).to_blob_status(epoch_expired),
            BlobStatus::Nonexistent,
        );
    }
}
