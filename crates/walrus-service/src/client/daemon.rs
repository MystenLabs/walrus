...
use routes::{
    BLOB_CONCAT_ENDPOINT, BLOB_GET_ENDPOINT, BLOB_OBJECT_GET_ENDPOINT, BLOB_PUT_ENDPOINT,
    LIST_PATCHES_IN_QUILT_ENDPOINT, QUILT_PATCH_BY_ID_GET_ENDPOINT,
