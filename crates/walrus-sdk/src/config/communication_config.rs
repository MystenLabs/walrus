...
pub const DEFAULT_AUTO_TUNE_WINDOW_SAMPLE_TARGET: usize = 10;
...
pub const DEFAULT_AUTO_TUNE_INCREASE_FACTOR: f64 = 1.5;
/// Default lock factor applied to the best-performing permit count.
pub const DEFAULT_AUTO_TUNE_LOCK_FACTOR: f64 = 0.9;
...
pub const DEFAULT_AUTO_TUNE_MAX_PERMITS: usize = 1_000;
...
fn default_auto_tune_window_sample_target() -> usize {
    DEFAULT_AUTO_TUNE_WINDOW_SAMPLE_TARGET
}

fn default_auto_tune_window_timeout() -> Duration {
    DEFAULT_AUTO_TUNE_WINDOW_TIMEOUT
}

fn default_auto_tune_increase_factor() -> f64 {
    DEFAULT_AUTO_TUNE_INCREASE_FACTOR
}

fn default_auto_tune_lock_factor() -> f64 {
    DEFAULT_AUTO_TUNE_LOCK_FACTOR
}

fn default_auto_tune_min_permits() -> usize {
    DEFAULT_AUTO_TUNE_MIN_PERMITS
}

fn default_auto_tune_max_permits() -> usize {
    DEFAULT_AUTO_TUNE_MAX_PERMITS
}

fn default_auto_tune_secondary_weight() -> f64 {
    DEFAULT_AUTO_TUNE_SECONDARY_WEIGHT
}
...
pub struct DataInFlightAutoTuneConfig {
    ...
    #[serde(default = "default_auto_tune_window_sample_target")]
