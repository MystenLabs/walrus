...
pub struct ClientCommunicationConfig {
    ...
    /// Optional limit under which the client skips the sliver status check before uploads.
    ///
    /// `None` disables the check entirely.
    pub sliver_status_check_threshold: Option<usize>,
...
impl Default for ClientCommunicationConfig {
    fn default() -> Self {
        Self {
            ...
            sliver_status_check_threshold: Some(DEFAULT_SLIVER_STATUS_CHECK_THRESHOLD),
