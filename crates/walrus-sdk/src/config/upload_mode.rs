...
impl UploadMode {
    ...
    pub fn apply_to(
        self,
        mut config: ClientCommunicationConfig,
        force: bool,
        ...
        // Note: we intentionally do not modify per-node max connections here; presets focus on
        // bytes-in-flight and global concurrency. Users can tune request rate limits explicitly.
